...
public class oppgave3<T> {
    ...
    public oppgave3<T> subliste(int fra, int til) {
        fraTilKontroll(fra, til);
        oppgave3<T> subListe = new oppgave3<>();
    ...
    public static void main(String[] args) {
        Integer[] a = {1, 2, 3, 4, 5};
        oppgave3<Integer> liste = new oppgave3<>(a);
        ...
        int fra = 1;
        int til = 4;
        oppgave3<Integer> subListe = liste.subliste(fra, til);
